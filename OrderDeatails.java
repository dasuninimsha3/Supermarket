 ...
 * @author sanja
 */
public class OrderDeatails extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(OrderDeatails.class.getName());

    /**
     * Creates new form OrderDeatails
     */
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order ID", "Supplier", "Order Date", "Status"
            }
        ));
...
Settings in = new Settings();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new OrderDeatails().setVisible(true));
    }
